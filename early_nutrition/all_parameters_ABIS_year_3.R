...
load_all_parameter <- function(){
  ...
  labels = list(c("0-1", "1-2", "3-4 or more" ))
  ...
  breaks = list(c(0,1,2,3,5))
  labels = list(c("nothing", "1-2 dl", "3-6 dl", "7-10 dl or more"))
  ...
  breaks = list(c(0,1,2,4))
  labels = list(c( "daily", "3-5 times/week", "seldom to 1-2 times/week"))
  ...
  breaks = list(c(0,3,4))
  labels = list(c("1-2 times/week to daily","seldom"))
  # labels = list(c("daily","3-5 times/week","1-2 times/week","seldom"))
