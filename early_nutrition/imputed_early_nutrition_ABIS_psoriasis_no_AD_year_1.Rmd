...
```{r}
variables2test <- names(original_psoriasis_data_full)[c(4:29,2)]
...
Hypothesis test not done because the H0 model has one or more non-estimable coefficients (huge standard error).
